 ...
 * ------------------------------------------------ */
const themeBtn=document.querySelector(".color-switcher");function getCurrentTheme(){let e=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light";return localStorage.getItem("helio.theme")&&(e=localStorage.getItem("helio.theme")),e}function loadTheme(e){const t=document.querySelector(":root");themeBtn.innerHTML="light"===e?'<em></em><i class="ph ph-moon-stars"></i>':'<em></em><i class="ph ph-sun"></i>',t.setAttribute("color-scheme",`${e}`)}themeBtn.addEventListener("click",(()=>{let e=getCurrentTheme();e="dark"===e?"light":"dark",localStorage.setItem("helio.theme",`${e}`),loadTheme(e)})),window.addEventListener("DOMContentLoaded",(()=>{loadTheme(getCurrentTheme())})),$((function(){"use strict";Modernizr.svg||$("img[src*='svg']").attr("src",(function(){return $(this).attr("src").replace(".svg",".png")}));try{$.browserSelector(),$("html").hasClass("chrome")&&$.smoothScroll()}catch(e){}$("img, a").on("dragstart",(function(e){e.preventDefault()})),/Android|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?$("html").addClass("touch"):$("html").addClass("no-touch"),/MSIE 9/i.test(navigator.userAgent)||/rv:11.0/i.test(navigator.userAgent)||/MSIE 10/i.test(navigator.userAgent)||/Edge\/\d+/.test(navigator.userAgent);var e=$("#menu-trigger"),t=$("#menu"),n=$("#color-switcher"),i=$("#main"),r=$("#about"),s=$("#works"),a=$("#contact"),o=$("#about-trigger"),l=$("#about-trigger-bottom"),c=$("#works-trigger"),d=$("#contact-trigger"),u=$("#about-close"),p=$("#works-close"),f=$("#contact-close");e.on("click",(function(n){n.preventDefault(),t.toggleClass("is-visible"),e.toggleClass("menu-is-visible")})),o.on("click",(function(s){s.preventDefault(),i.addClass("animate-out"),r.addClass("animate-in"),setTimeout((function(){n.addClass("inner-is-visible")}),500),setTimeout((function(){t.removeClass("is-visible"),e.removeClass("menu-is-visible")}),800)})),l.on("click",(function(s){s.preventDefault(),i.addClass("animate-out"),r.addClass("animate-in"),setTimeout((function(){n.addClass("inner-is-visible")}),500),setTimeout((function(){t.removeClass("is-visible"),e.removeClass("menu-is-visible")}),800)})),u.on("click",(function(e){e.preventDefault(),i.removeClass("animate-out"),r.removeClass("animate-in"),setTimeout((function(){n.removeClass("inner-is-visible")}),100),setTimeout((function(){r.animate({scrollTop:0}),$("#about .inner__info").animate({scrollTop:0})}),600)})),c.on("click",(function(r){r.preventDefault(),i.addClass("animate-out"),s.addClass("animate-in"),setTimeout((function(){n.addClass("inner-is-visible")}),500),setTimeout((function(){t.removeClass("is-visible"),e.removeClass("menu-is-visible")}),800)})),p.on("click",(function(e){e.preventDefault(),i.removeClass("animate-out"),s.removeClass("animate-in"),setTimeout((function(){n.removeClass("inner-is-visible")}),100),setTimeout((function(){s.animate({scrollTop:0}),$("#works .inner__info").animate({scrollTop:0})}),600)})),d.on("click",(function(r){r.preventDefault(),i.addClass("animate-out"),a.addClass("animate-in"),setTimeout((function(){n.addClass("inner-is-visible")}),500),setTimeout((function(){t.removeClass("is-visible"),e.removeClass("menu-is-visible")}),800)})),f.on("click",(function(e){e.preventDefault(),i.removeClass("animate-out"),a.removeClass("animate-in"),setTimeout((function(){n.removeClass("inner-is-visible")}),100),setTimeout((function(){a.animate({scrollTop:0}),$("#contact .inner__info").animate({scrollTop:0})}),600)}));var m=$("#notify"),h=$("#notify-trigger"),g=$("#notify-close");h.on("click",(function(e){e.preventDefault(),m.addClass("animate-in").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",(function(){g.addClass("is-scaled-up")}))})),g.on("click",(function(e){e.preventDefault(),g.removeClass("is-scaled-up"),setTimeout((function(){m.addClass("animate-out")}),300),setTimeout((function(){m.removeClass("animate-in animate-out")}),1e3)})),$(".hover-anim").on("mouseenter",(function(e){var t=$(this).offset(),n=e.pageX-t.left,i=e.pageY-t.top;$(this).find("em").css({top:i,left:n})})).on("mouseout",(function(e){var t=$(this).offset(),n=e.pageX-t.left,i=e.pageY-t.top;$(this).find("em").css({top:i,left:n})})),$(".my-gallery__link").each((function(){$(this).append('<div class="picture"></div>').children(".picture").css({"background-image":"url("+$(this).attr("data-image")+")"})}))}));